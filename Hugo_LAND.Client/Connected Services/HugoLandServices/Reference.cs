...
namespace Hugo_LAND.Client.HugoLandServices {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="InventoryDetailsDTO", Namespace="http://schemas.datacontract.org/2004/07/Hugo_LAND.WCF.DTOs")]
    [System.SerializableAttribute()]
    public partial class InventoryDetailsDTO : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
    ...
    public interface IHeroService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHeroService/ArmorHero", ReplyAction="http://tempuri.org/IHeroService/ArmorHeroResponse")]
        Hugo_LAND.Client.HugoLandServices.HeroDetailsDTO ArmorHero(int world, int newX, int newY, Hugo_LAND.Client.HugoLandServices.HeroDetailsDTO hero, int idItem, bool force);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHeroService/ArmorHero", ReplyAction="http://tempuri.org/IHeroService/ArmorHeroResponse")]
        System.Threading.Tasks.Task<Hugo_LAND.Client.HugoLandServices.HeroDetailsDTO> ArmorHeroAsync(int world, int newX, int newY, Hugo_LAND.Client.HugoLandServices.HeroDetailsDTO hero, int idItem, bool force);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHeroService/FoodHero", ReplyAction="http://tempuri.org/IHeroService/FoodHeroResponse")]
        Hugo_LAND.Client.HugoLandServices.HeroDetailsDTO FoodHero(int world, int newX, int newY, Hugo_LAND.Client.HugoLandServices.HeroDetailsDTO hero, int idItem, bool force);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHeroService/FoodHero", ReplyAction="http://tempuri.org/IHeroService/FoodHeroResponse")]
        System.Threading.Tasks.Task<Hugo_LAND.Client.HugoLandServices.HeroDetailsDTO> FoodHeroAsync(int world, int newX, int newY, Hugo_LAND.Client.HugoLandServices.HeroDetailsDTO hero, int idItem, bool force);
    }
    ...
    public partial class HeroServiceClient : System.ServiceModel.ClientBase<Hugo_LAND.Client.HugoLandServices.IHeroService>, Hugo_LAND.Client.HugoLandServices.IHeroService {
        ...
        public Hugo_LAND.Client.HugoLandServices.HeroDetailsDTO ArmorHero(int world, int newX, int newY, Hugo_LAND.Client.HugoLandServices.HeroDetailsDTO hero, int idItem, bool force) {
            return base.Channel.ArmorHero(world, newX, newY, hero, idItem, force);
        }
        
        public System.Threading.Tasks.Task<Hugo_LAND.Client.HugoLandServices.HeroDetailsDTO> ArmorHeroAsync(int world, int newX, int newY, Hugo_LAND.Client.HugoLandServices.HeroDetailsDTO hero, int idItem, bool force) {
            return base.Channel.ArmorHeroAsync(world, newX, newY, hero, idItem, force);
        }
        
        public Hugo_LAND.Client.HugoLandServices.HeroDetailsDTO FoodHero(int world, int newX, int newY, Hugo_LAND.Client.HugoLandServices.HeroDetailsDTO hero, int idItem, bool force) {
            return base.Channel.FoodHero(world, newX, newY, hero, idItem, force);
        }
        
        public System.Threading.Tasks.Task<Hugo_LAND.Client.HugoLandServices.HeroDetailsDTO> FoodHeroAsync(int world, int newX, int newY, Hugo_LAND.Client.HugoLandServices.HeroDetailsDTO hero, int idItem, bool force) {
            return base.Channel.FoodHeroAsync(world, newX, newY, hero, idItem, force);
        }
    }
